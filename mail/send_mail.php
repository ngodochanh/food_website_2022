...
class Mailer {
    public function dathangmail($title, $content, $gmail_customer, $name) {
        ...
        try {
            ...
            $mail->Username = 'qtrung792@gmail.com';                 // SMTP username
            $mail->Password = 'slebztzztxzvagaw';                           // SMTP password
